...
<section>
	...
	<div class="row gtr-uniform">
		...
		<div class="col-12">
			<div class="alert alert-warning" id="alert-warning" hidden>숫자 4자리로 입력해주세요.</div>
			<div class="alert alert-success" id="alert-success" hidden>비밀번호가 일치합니다.</div>
			<div class="alert alert-danger" id="alert-danger" hidden>비밀번호가 일치하지 않습니다.</div>
		</div>
